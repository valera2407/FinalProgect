...
public final class Answers {
    ...
    public static final int getBookPageCount = 4200;
    public static final String getBookTitle = "Book 42";

    public static final int createPutId = 1587;
    public static final int createPutPageCount = 1245;
